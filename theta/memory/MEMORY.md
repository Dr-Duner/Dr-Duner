...
- `../compliance/COMPLIANCE.md` — LIVING regulatory investigation
  (parallel to DESIGN.md). Characterization RESOLVED 2026-05-20 as
  strategy SaaS tool + education; 7 red flags closed by design;
  middle-position playbook in §17.
- `../ai/PEDAGOGY.md` — LIVING teaching architecture for the
  strategy-teacher LLM. The defensible IP layer as AI commoditizes:
